                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="update.php?id=<?php echo $id; ?>">
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="NAME" name="name" value="<?php echo $name ?>">
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <input type="date" placeholder="BIRTHDATE" name="birthday" value="<?php echo $date ?>">
                                </div>
                            </div>
