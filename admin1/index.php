    ...
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="register.php">AAH</a></li>
          <li><a class="nav-link scrollto" href="register.php">PDH</a></li>
          <li><a class="nav-link scrollto" href="register.php"> Joachim Villa/ Ennagam</a></li>
...
<div>&nbsp;
<table cellpadding="0" cellspacing="0" class="table table-striped table-hover table-bordered" style="border: 1px solid #ccc;">


		<tr>
			<td><strong>Convener (Rector)</strong></td>
			<td>Fr Bosco Augustine SDB&nbsp;</td>
		</tr>
		<tr>
			<td><strong>Director : PDH</strong></td>
			<td>Fr Amalavanan F SDB</td>
		</tr>
		<tr>
			<td><strong>IC : Arockia Annai Hostel</strong></td>
			<td>Sr Philo Rani FMA</td>
		</tr>
		<tr>
			<td><strong>Director : Joachim Villa/ Ennagam</strong></td>
			<td>Fr Xavier Raj S SDB</td>
		</tr>
		<tr>
			<td><strong>DB-Extension Centre-Nilavur</strong></td>
			<td>Fr M J Arun SDB</td>
		</tr>
